...
嗨，我是你的 AI 情感諮商師。在聽完你們的故事之後，我想跟你分享我得出的分析結果，希望這能幫助你更了解自己與對方的行為模式。

目前我還缺少一些關鍵資訊，無法完整完成報告。為了給予你最精準、最有幫助的分析，請你提供以下資料：

1. **您的姓名**  
2. **伴侶的姓名**  
3. **情感問題的主觀描述**（你感受到的困擾、情緒、事件的經過等）  
4. **實際聊天紀錄**（或至少其中的幾段關鍵對話，能讓我辨識是否出現 Gottman 末日四騎士的語句）  

有了這些資訊，我就能依照「四種依附類型」與「Gottman 末日四騎士」的框架，為你撰寫完整的 **情感關係深度分析報告**，包括：
